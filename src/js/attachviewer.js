...
class AttachViewer {
	...
	open (i) {
		...
		if(el){
			...
			th.downloadBtn.addEventListener('click',()=>{if(th.opts.closeOnDownload){th.close()}}, false)
			...
			th.showBtn.addEventListener('click', ()=>{if(th.opts.closeOnShow)th.close()},false);
